...
ALTER TABLE MATRICULA_ASIGNATURAS DROP CONSTRAINT MATRICULAASIGNATURASListado_Asignaturas_REFERENCIA
ALTER TABLE MATRICULA_ASIGNATURAS DROP CONSTRAINT FK_MATRICULA_ASIGNATURAS_CURSO_ACADEMICO
