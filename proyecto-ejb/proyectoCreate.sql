...
CREATE TABLE GRUPO (ID VARCHAR(255) NOT NULL, ASIGNABLE BOOLEAN, CURSO VARCHAR(20) NOT NULL UNIQUE, GRUPO_PREFERENTE VARCHAR(1), INGLES BOOLEAN NOT NULL, LETRA VARCHAR(1) NOT NULL UNIQUE, PLAZAS NUMERIC(38) NOT NULL, TURNO_MANANA_TARDE VARCHAR(20) NOT NULL, VISIBLE BOOLEAN, grupoID VARCHAR(255), TITULACION_CODIGO INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE jn_tit_opt (optativa_REFERENCIA INTEGER NOT NULL, titulaciones_CODIGO INTEGER NOT NULL, PRIMARY KEY (optativa_REFERENCIA, titulaciones_CODIGO))
CREATE TABLE jn_tit_cntr (centro_fk VARCHAR(52) NOT NULL, tit_fk INTEGER NOT NULL, PRIMARY KEY (centro_fk, tit_fk))
