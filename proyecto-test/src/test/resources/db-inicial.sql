...
insert into `Alumno` values ('1','Gonzalez',NULL,NULL,'12345678x',NULL,'pepito@uma.es',NULL,NULL,NULL,'Pepito',NULL,NULL),('2','Lopez',NULL,NULL,'87654321a',NULL,'luisa@uma.es',NULL,NULL,NULL,'Luisa',NULL,NULL);
...
insert into `Encuesta` values ('27-07-2000','4A',NULL,NULL,NULL,123456789);
