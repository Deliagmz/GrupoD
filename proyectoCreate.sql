...
CREATE TABLE MATRICULA_ASIGNATURAS (CURSO_ACADEMICO VARCHAR NOT NULL, EXPEDIENTES_NUM_EXPEDIENTE BIGINT NOT NULL, Listado_Asignaturas_REFERENCIA INTEGER NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EXPEDIENTES_NUM_EXPEDIENTE, Listado_Asignaturas_REFERENCIA))
